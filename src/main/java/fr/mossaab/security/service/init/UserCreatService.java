...
public class UserCreatService {
    ...
    private void createUser(Long id, String firstname, String lastname, String email,
                            ...
                            String dateOfBirthStr, String workerRoleStr) {
        try {
